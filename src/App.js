        ...
        {this.state.idFound ? (
          ...
          {this.state.r2ended[1] ? (
            <form onSubmit={this.update3}>
              <legend>2024 NFL Super Bowl</legend>
           ...
           {this.state.r1ended[3] ? (
            <div>
            <legend>2024 NFL Conference Championships</legend>
            ...
            <form onSubmit={this.update}>
                <legend>2024 NFL Divisional Round</legend>
          ...
          <div>
            <h1>Welcome to the 2024 NFL Playoff Pool!</h1>
